                ...
                <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
                    <div class="modal-content" style="background-color: #000005">
                            ...
                            <div class="col-md-4 text-info">
                                ...
                                <p>
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control form-control-sm" value="${festival.getNumOfOutPatient()}" placeholder="Number Of Out Patient" id="inputDefault">
                                        
                                        <label class="col-form-label col-form-label-sm" for="inputDefault1">Number Of In Patient:</label>
                                        <input type="number" class="form-control form-control-sm" value="${festival.getNumOfInPatient()}" placeholder="Number Of In Patient" id="inputDefault1">
                                        
                                        <label class="col-form-label col-form-label-sm" for="inputDefault2">Number Of Patient:</label>
                                        <input type="number" class="form-control form-control-sm" value="${festival.getNumOfPatients()}" placeholder="Number Of Patient" id="inputDefault2">
                                        
                                        <label class="col-form-label col-form-label-sm" for="inputDefault3">Number Of Beds:</label>
                                        <input type="number" class="form-control form-control-sm" value="${festival.getNumOfBeds()}" placeholder="Number Of Beds" id="inputDefault3">
                                    </div>
                                </p>
                            </div>
                            <div class="col-md-4 text-info">
                                ...
                                <p>
                                    <div class="form-group">
                                        ...
                                        <input type="email" class="form-control form-control-sm" value="${festival.getDirectorEmail()}" placeholder="Director Email" id="inputDefault4">
                                        
                                        <label class="col-form-label col-form-label-sm" for="inputDefault5">Director Name:</label>
                                        <input type="text" class="form-control form-control-sm" value="${festival.getDirectorName()}" placeholder="Director Name" id="inputDefault5">
                                        
                                        <label class="col-form-label col-form-label-sm" for="inputDefault6">Director Phone:</label>
                                        <input type="tel" class="form-control form-control-sm" value="${festival.getDirectorPhone()}" placeholder="Director Phone" id="inputDefault6">
                                    </div>
                                </p>
                            </div>
                            <div class="col-md-4 text-info">
                                ...
                                <p>
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control form-control-sm" value="${festival.getLicenseNum()}" placeholder="License Number" id="inputDefault7">
                                        
                                        <label class="col-form-label col-form-label-sm" for="inputDefault8">Phone:</label>
                                        <input type="tel" class="form-control form-control-sm" value="${festival.getPhone()}" placeholder="Phone" id="inputDefault8">
                                        
                                        <label class="col-form-label col-form-label-sm" for="inputDefault9">Address:</label>
                                        <input type="text" class="form-control form-control-sm" value="${festival.getAddress()}" placeholder="Address" id="inputDefault9">
                                        
                                        <label class="col-form-label col-form-label-sm" for="inputDefault10">Country:</label>
                                        <input type="text" class="form-control form-control-sm" value="${festival.getCountry()}" placeholder="Country" id="inputDefault10">
                                    </div>
                                </p>
                            </div>
                        </div>
                        <div class="modal-footer">
                            ...
                            <div class="col-md-6 btn-group mb-1">
                                <button type="button" class="btn btn-primary btn-md"><i class="fa fa-wrench" style="font-size: 1.1em" aria-hidden="true"></i> Update</button>
                                <button type="button" class="btn btn-primary btn-md"><i class="fa fa-trash-o" style="font-size: 1.1em" aria-hidden="true"></i> Delete</button>
