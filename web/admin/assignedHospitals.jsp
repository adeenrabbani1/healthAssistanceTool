    ...
    <body style="background-color: #f5f5f5">
        <div class="container-fluid">
            <div class="mt-5 mb-3 text-center">
                ...
                <h4><i class="fa fa-calendar-check-o" style="font-size:24px"></i> assigned hospitals</h4>
                <br>
                ...
                <c:forEach items="${hospitals}" var="festival">
                    <c:choose>
                        <c:when test="${festival.getSurID() > 0}">
                            <div class="card text-white bg-info border-primary m-3" style="max-width: 20rem; box-shadow: 0 4px 8px 4px rgba(0, 0, 0, 0.4); border-radius: 5px">
